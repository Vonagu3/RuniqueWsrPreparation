...
import com.example.runiquewsrpreparation.ui.theme.RuniqueBlack
import com.example.runiquewsrpreparation.ui.theme.RuniqueGray
...
fun RuniqueActionButton(
    ...
    Button(
        ...
        RuniqueButtonContent(text, isLoading, modifier)
    }
}
...
@Composable
private fun RuniqueButtonContent(
    text: String,
    isLoading: Boolean,
    modifier: Modifier = Modifier,
) {
